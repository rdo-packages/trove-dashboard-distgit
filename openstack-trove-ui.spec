...
%{_datadir}/openstack-dashboard/openstack_dashboard/local/enabled/_1760_project_database_configuration_panel.py*
...
%{_sysconfdir}/openstack-dashboard/enabled/_1760_project_database_configuration_panel.py*
